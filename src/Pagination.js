    ...
    return (
        <div id = "paginationcontainer">
            <ul className="pagination">
                ...
                {pageNumbers.map((pageNumber)=> pageNumber == props.page ?
                <li className="page-item active" key = {pageNumber}><a a style={{cursor:"pointer"}} className="page-link" onClick={() => {props.setCurrentPage(pageNumber)}}>{pageNumber}</a></li> :
                <li className="page-item" key = {pageNumber}><a a style={{cursor:"pointer"}} className="page-link" onClick={() => {props.setCurrentPage(pageNumber)}}>{pageNumber}</a></li>
                )}
