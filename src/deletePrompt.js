...
const DeletePrompt = (props) => {
    ...
    let handleDelete = (id) => {
        console.log(id)
        fetch("https://ugdymo-istaiga.fly.dev/api/deletepupil/" + props.deletionId, {method: 'DELETE', headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${auth.getToken()}` }})
